...
<manifest xmlns:android="http://schemas.android.com/apk/res/android"
    package="com.geektime.rnonesignalandroid.test" >
    ...
    <instrumentation
        ...
        android:label="Tests for com.geektime.rnonesignalandroid.test"
        android:targetPackage="com.geektime.rnonesignalandroid.test" />
    <!-- Create a unique permission for your app and use it so only your app can receive your OneSignal messages. -->
    <permission
        android:name="com.geektime.rnonesignalandroid.test.permission.C2D_MESSAGE"
        android:protectionLevel="signature" />

    <uses-permission android:name="com.geektime.rnonesignalandroid.test.permission.C2D_MESSAGE" /> <!-- OneSignal SDK has runtime checks Android version. -->
    ...
    <application
        ...
        <receiver
            ...
            <intent-filter android:priority="999" >
                ...
                <category android:name="com.geektime.rnonesignalandroid.test" />
            </intent-filter>
        </receiver>
        ...
        <provider
            ...
            android:authorities="com.geektime.rnonesignalandroid.test.firebaseinitprovider"
            android:exported="false"
