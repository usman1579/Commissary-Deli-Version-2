...
class ProductVariable extends React.Component {
  handleChange = (meta_data) => {
    const {productAttributes, productVariations, selectVariation, updateMetaVariation} = this.props;
   ...
   */
  onSelectAttribute = (attribute_id, attribute_name, attribute_option) => {
